...
import { FaCalendarAlt, FaClock, FaMapMarkerAlt, FaTractor, FaRupeeSign, FaUser, FaPhone, FaCheckCircle, FaTimesCircle } from "react-icons/fa";
...
const Booking = () => {
  ...
  const cancelBooking = () => {
    ...
    const bookingToCancel = bookings.upcoming.find(b => b.id === selectedBooking.id);
    
    if (bookingToCancel) {
      // Remove from upcoming
      const updatedUpcoming = bookings.upcoming.filter(b => b.id !== selectedBooking.id);
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {activeBookings.map((booking) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-bold text-lg mb-2">{booking.vehicleName}</h3>
        ...
        {selectedBooking && !showCancelModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
              ...
              <div className="p-6">
                <h2 className="text-2xl font-bold mb-4">{selectedBooking.vehicleName}</h2>
                <p className="text-gray-600 mb-4">{selectedBooking.vehicleType}</p>
                ...
                {selectedBooking.status === "Completed" && !selectedBooking.rating && (
                  <div className="mb-6">
                    ...
                    <ReviewForm booking={selectedBooking} onSubmit={submitReview} />
                  </div>
                )}
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
            <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
              ...
              <p className="text-gray-600 mb-4">
                Are you sure you want to cancel your booking for {selectedBooking.vehicleName} on {new Date(selectedBooking.date).toLocaleDateString()}?
              </p>
