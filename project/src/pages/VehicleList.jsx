...
import { FaMapMarkerAlt, FaRupeeSign, FaStar, FaFilter, FaSearch } from "react-icons/fa";
...
const VehicleList = () => {
  ...
  const vehicleTypes = ["Tractor", "Harvester", "Rotavator", "Sprayer", "Plough"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center py-8 px-4 mb-8">
          ...
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Browse our selection of tractors, harvesters, and other farm equipment available for rent in your area.
          </p>
            ...
            <div key={vehicle.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-4">
                ...
                <div className="flex items-center text-sm text-gray-500 mb-3">
                  ...
                  <span>{vehicle.location} • {vehicle.distance} km away</span>
                </div>
        ...
        {sortedVehicles.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="mt-1 text-sm text-gray-500">Try adjusting your search filters or try a different location.</p>
            <div className="mt-6">
              <button 
                onClick={() => {
                  setSelectedTypes([]);
              ...
              <div className="p-6">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex items-center bg-green-100 px-3 py-1 rounded-full">
                    ...
                    <span className="font-bold text-green-600">{selectedVehicle.price}</span>
                    <span className="text-green-600">/{selectedVehicle.priceUnit}</span>
                  </div>
                </div>
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div className="flex items-center text-sm text-gray-500">
                    <FaMapMarkerAlt className="mr-1" />
                    <span>{selectedVehicle.location} • {selectedVehicle.distance} km away</span>
                  </div>
                </div>
                
                <p className="text-gray-700 mb-4">{selectedVehicle.description}</p>
                ...
                <div className="border-t pt-4 flex justify-between items-center">
                  <div>
                    ...
                    <p className="text-2xl font-bold">₹{selectedVehicle.price}</p>
                  </div>
