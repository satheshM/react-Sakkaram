...
import { FaTractor, FaEdit, FaTrash, FaPlus, FaCalendarAlt, FaToggleOn, FaToggleOff } from "react-icons/fa";
...
const MyVehicles = () => {
  ...
  const [vehicles, setVehicles] = useState([
    { 
      ...
      description: "Well-maintained tractor with all accessories. Perfect for plowing and transportation.",
      available: true,
  ...
  const addVehicle = () => {
    // Basic validation
    if (!newVehicle.type || !newVehicle.model || !newVehicle.number || !newVehicle.price) {
      alert("Please fill in all required fields");
      return;
    }
    
    // Add default image if none provided
    let vehicleImage = newVehicle.image;
    if (!vehicleImage) {
      if (newVehicle.type.toLowerCase().includes("tractor")) {
        vehicleImage = "https://5.imimg.com/data5/SELLER/Default/2021/12/QO/YC/XG/52189282/mahindra-575-di-tractor.jpg";
      } else if (newVehicle.type.toLowerCase().includes("harvester")) {
        vehicleImage = "https://5.imimg.com/data5/SELLER/Default/2021/1/KO/FV/IY/3042719/john-deere-w70-self-propelled-combine-harvester-500x500.jpg";
      } else {
        vehicleImage = "https://5.imimg.com/data5/SELLER/Default/2022/1/SI/TP/NG/144593388/massey-ferguson-rotavator-500x500.jpg";
      }
    }
  ...
  const updateVehicle = () => {
    // Basic validation
    if (!editingVehicle.type || !editingVehicle.model || !editingVehicle.number || !editingVehicle.price) {
      alert("Please fill in all required fields");
      return;
    }
  ...
  const vehicleTypes = ["Tractor", "Harvester", "Rotavator", "Sprayer", "Plough", "Cultivator", "Seeder"];
          ...
          <div className="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                ...
                <input
                  ...
                  value={editingVehicle ? editingVehicle.number : newVehicle.number}
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-md"
                  required
                />
              ...
              <div className="flex gap-2">
                ...
                <div className="w-1/3">
                  ...
                  <select
                    name="priceUnit"
                    value={editingVehicle ? editingVehicle.priceUnit : newVehicle.priceUnit}
                    onChange={handleChange}
                    className="w-full p-2 border border-gray-300 rounded-md"
                  >
              ...
              <div>
                ...
                <input
                  ...
                  value={editingVehicle ? editingVehicle.location : newVehicle.location}
                  onChange={handleChange}
                  className="w-full p-2 border border-gray-300 rounded-md"
                  required
                />
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap gap-2 mt-2">
                {(editingVehicle ? editingVehicle.features : newVehicle.features).map((feature, index) => (
            ...
            <div className="mb-4">
              ...
              <textarea
                ...
                value={editingVehicle ? editingVehicle.description : newVehicle.description}
                onChange={handleChange}
                className="w-full p-2 border border-gray-300 rounded-md"
                rows="3"
              ></textarea>
            ...
            <div className="mb-4">
              <label className="flex items-center">
                <input
                  type="checkbox"
                  name="available"
                  checked={editingVehicle ? editingVehicle.available : newVehicle.available}
                  onChange={(e) => {
                    if (editingVehicle) {
            ...
            {filteredVehicles.map((vehicle) => (
              <div key={vehicle.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
                <div className="relative">
                  ...
                  />
                  <div className={`absolute top-0 right-0 ${vehicle.available ? 'bg-green-500' : 'bg-red-500'} text-white px-2 py-1 m-2 rounded-full text-xs font-medium`}>
                ...
                <div className="p-4">
                  ...
                  <p className="text-gray-600 text-sm mb-2">{vehicle.type} • {vehicle.number}</p>
                  ...
                  <div className="mb-3">
                    <p className="font-bold text-green-600">₹{vehicle.price}/{vehicle.priceUnit}</p>
                  </div>
                  ...
                  <div className="flex justify-between items-center mt-4">
                    <button
                      ...
                      className={`flex items-center text-sm ${vehicle.available ? 'text-red-600' : 'text-green-600'}`}
                    >
                      {vehicle.available ? (
                        <>
